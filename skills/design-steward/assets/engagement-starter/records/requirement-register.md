...
Use immutable requirement IDs. If an accepted requirement changes, create a new ID and link both directions through the record index; do not rewrite the accepted row.
